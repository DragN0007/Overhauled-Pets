...
@OnlyIn(Dist.CLIENT)
public class AustralianShepherdCollarLayer extends GeoRenderLayer<AustralianShepherd> {
    ...
    public AustralianShepherdCollarLayer(GeoRenderer<AustralianShepherd> entityRendererIn) {
        super(entityRendererIn);
    }

    @Override
    public void render(PoseStack poseStack, AustralianShepherd animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
