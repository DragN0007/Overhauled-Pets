...
public class FoxhoundRender extends GeoEntityRenderer<Foxhound> {

    public FoxhoundRender(EntityRendererProvider.Context renderManager) {
        super(renderManager, new FoxhoundModel());
        this.addRenderLayer(new FoxhoundMarkingLayer(this));
        this.addRenderLayer(new FoxhoundCollarLayer(this));
        this.addRenderLayer(new FoxhoundDecorLayer(this));
    }

    @Override
    public void render(Foxhound entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
