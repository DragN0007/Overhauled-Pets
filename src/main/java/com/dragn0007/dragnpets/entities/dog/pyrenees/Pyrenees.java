...
public class Pyrenees extends DogBase implements NeutralMob, GeoEntity {

   public static final EntityDataAccessor<Integer> DATA_COLLAR_COLOR = SynchedEntityData.defineId(Pyrenees.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> DATA_REMAINING_ANGER_TIME = SynchedEntityData.defineId(Pyrenees.class, EntityDataSerializers.INT);
...
//      this.goalSelector.addGoal(6, new DogFollowOwnerGoal(this, 1.0D, 10.0F, 2.0F, false));
   ...
   public static final EntityDataAccessor<Integer> OVERLAY = SynchedEntityData.defineId(Pyrenees.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Boolean> COLLARED = SynchedEntityData.defineId(Pyrenees.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Integer> CROPPED = SynchedEntityData.defineId(Pyrenees.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> FLUFFY = SynchedEntityData.defineId(Pyrenees.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> DATA_VEST_COLOR = SynchedEntityData.defineId(Pyrenees.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Boolean> VEST = SynchedEntityData.defineId(Pyrenees.class, EntityDataSerializers.BOOLEAN);
   ...
   public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
      ...
      DogBase pup = null;
      Pyrenees partner = (Pyrenees) ageableMob;

      if (ageableMob instanceof Pyrenees) {
         pup = POEntityTypes.PYRENEES_ENTITY.get().create(serverLevel);
