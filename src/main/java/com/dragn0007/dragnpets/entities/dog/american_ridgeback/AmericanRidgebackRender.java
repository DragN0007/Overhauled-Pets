...
public class AmericanRidgebackRender extends GeoEntityRenderer<AmericanRidgeback> {

    public AmericanRidgebackRender(EntityRendererProvider.Context renderManager) {
        super(renderManager, new AmericanRidgebackModel());
        this.addRenderLayer(new AmericanRidgebackMarkingLayer(this));
        this.addRenderLayer(new AmericanRidgebackCollarLayer(this));
        this.addRenderLayer(new AmericanRidgebackDecorLayer(this));
    }

    @Override
    public void render(AmericanRidgeback entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
