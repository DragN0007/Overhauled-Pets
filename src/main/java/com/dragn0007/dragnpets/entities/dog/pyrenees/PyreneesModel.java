...
public class PyreneesModel extends DefaultedEntityGeoModel<Pyrenees> {

    public PyreneesModel() {
        super(new ResourceLocation(LivestockOverhaul.MODID, "pyrenees"), true);
    }

    @Override
    public void setCustomAnimations(Pyrenees animatable, long instanceId, AnimationState<Pyrenees> animationState) {
    ...
    public static final ResourceLocation MODEL = new ResourceLocation(PetsOverhaul.MODID, "geo/dog/pyrenees.geo.json");
