...
public class WhippetMarkingLayer extends GeoRenderLayer<Whippet> {
    ...
    public enum Overlay {
        ...
        FULL(new ResourceLocation(PetsOverhaul.MODID, "textures/entity/dog/whippet/overlay/whippet_full_overlay.png")),
        SOCKS(new ResourceLocation(PetsOverhaul.MODID, "textures/entity/dog/whippet/overlay/whippet_socks_overlay.png")),
        SPOT(new ResourceLocation(PetsOverhaul.MODID, "textures/entity/dog/whippet/overlay/whippet_spot_overlay.png")),
        WHITE(new ResourceLocation(PetsOverhaul.MODID, "textures/entity/dog/whippet/overlay/whippet_white_overlay.png"));
