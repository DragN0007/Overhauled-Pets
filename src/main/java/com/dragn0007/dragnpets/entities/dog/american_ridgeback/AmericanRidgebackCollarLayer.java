...
@OnlyIn(Dist.CLIENT)
public class AmericanRidgebackCollarLayer extends GeoRenderLayer<AmericanRidgeback> {

    public AmericanRidgebackCollarLayer(GeoRenderer<AmericanRidgeback> entityRendererIn) {
