...
public class FoxhoundModel extends DefaultedEntityGeoModel<Foxhound> {

    public FoxhoundModel() {
        super(new ResourceLocation(LivestockOverhaul.MODID, "foxhound"), true);
    }

    @Override
    public void setCustomAnimations(Foxhound animatable, long instanceId, AnimationState<Foxhound> animationState) {
