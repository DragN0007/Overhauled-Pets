...
public class BeagleRender extends GeoEntityRenderer<Beagle> {

    public BeagleRender(EntityRendererProvider.Context renderManager) {
        super(renderManager, new BeagleModel());
        this.addRenderLayer(new BeagleMarkingLayer(this));
        this.addRenderLayer(new BeagleCollarLayer(this));
        this.addRenderLayer(new BeagleDecorLayer(this));
    }

    @Override
    public void render(Beagle entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
