...
public class ODogModel extends DefaultedEntityGeoModel<ODog> {
    ...
    @Override
    public void setCustomAnimations(ODog animatable, long instanceId, AnimationState<ODog> animationState) {
...
//    public static final ResourceLocation MODEL = new ResourceLocation(PetsOverhaul.MODID, "geo/dog/o_dog.geo.json");
    ...
    @Override
    public ResourceLocation getTextureResource(ODog object) {
        return object.getTextureLocation();
    }

    @Override
    public ResourceLocation getAnimationResource(ODog animatable) {
        return ANIMATION;
    }
}
