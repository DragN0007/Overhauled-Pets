...
@OnlyIn(Dist.CLIENT)
public class FoxhoundCollarLayer extends GeoRenderLayer<Foxhound> {

    public FoxhoundCollarLayer(GeoRenderer<Foxhound> entityRendererIn) {
        super(entityRendererIn);
    }

    @Override
    public void render(PoseStack poseStack, Foxhound animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
