...
public class AmericanRidgeback extends DogBase implements NeutralMob, GeoEntity {

   public static final EntityDataAccessor<Integer> DATA_COLLAR_COLOR = SynchedEntityData.defineId(AmericanRidgeback.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> DATA_REMAINING_ANGER_TIME = SynchedEntityData.defineId(AmericanRidgeback.class, EntityDataSerializers.INT);

   public static final UniformInt PERSISTENT_ANGER_TIME = TimeUtil.rangeOfSeconds(20, 39);
   @Nullable
   public UUID persistentAngerTarget;

   public AmericanRidgeback(EntityType<? extends AmericanRidgeback> entityType, Level level) {
...
//      this.goalSelector.addGoal(6, new DogFollowOwnerGoal(this, 1.0D, 10.0F, 2.0F, false));
   ...
   public void tick() {
      ...
      if (this.getHealth() < this.getMaxHealth() && regenHealthCounter >= 75 && this.isTame() && this.isAlive()) {
   ...
   public static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(AmericanRidgeback.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> OVERLAY = SynchedEntityData.defineId(AmericanRidgeback.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Boolean> COLLARED = SynchedEntityData.defineId(AmericanRidgeback.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Integer> CROPPED = SynchedEntityData.defineId(AmericanRidgeback.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> FLUFFY = SynchedEntityData.defineId(AmericanRidgeback.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> DATA_VEST_COLOR = SynchedEntityData.defineId(AmericanRidgeback.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Boolean> VEST = SynchedEntityData.defineId(AmericanRidgeback.class, EntityDataSerializers.BOOLEAN);
   ...
   public static final EntityDataAccessor<Integer> GENDER = SynchedEntityData.defineId(AmericanRidgeback.class, EntityDataSerializers.INT);
   ...
   public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
      ...
      AmericanRidgeback pup = null;
      AmericanRidgeback partner = (AmericanRidgeback) ageableMob;

      if (ageableMob instanceof AmericanRidgeback) {

         pup = POEntityTypes.AMERICAN_RIDGEBACK_ENTITY.get().create(serverLevel);
   ...
   public boolean wantsToAttack(LivingEntity entity, LivingEntity p_30390_) {
      if (!(entity instanceof Creeper) && !(entity instanceof Ghast)) {
         if (entity instanceof AmericanRidgeback) {
            AmericanRidgeback wolf = (AmericanRidgeback)entity;
