...
@OnlyIn(Dist.CLIENT)
public class JackRussellCollarLayer extends GeoRenderLayer<JackRussell> {

    public JackRussellCollarLayer(GeoRenderer<JackRussell> entityRendererIn) {
        super(entityRendererIn);
    }

    @Override
    public void render(PoseStack poseStack, JackRussell animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
