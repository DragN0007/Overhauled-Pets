...
public class JackRussellRender extends GeoEntityRenderer<JackRussell> {

    public JackRussellRender(EntityRendererProvider.Context renderManager) {
        super(renderManager, new JackRussellModel());
        this.addRenderLayer(new JackRussellMarkingLayer(this));
        this.addRenderLayer(new JackRussellCollarLayer(this));
        this.addRenderLayer(new JackRussellDecorLayer(this));
    }

    @Override
    public void render(JackRussell entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
