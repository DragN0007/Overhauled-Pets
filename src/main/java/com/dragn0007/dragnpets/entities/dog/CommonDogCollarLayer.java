...
@OnlyIn(Dist.CLIENT)
public class CommonDogCollarLayer extends GeoRenderLayer<CommonDog> {
    ...
    public CommonDogCollarLayer(GeoRenderer<CommonDog> entityRendererIn) {
        super(entityRendererIn);
    }

    @Override
    public void render(PoseStack poseStack, CommonDog animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
