...
public class CoonhoundRender extends GeoEntityRenderer<Coonhound> {

    public CoonhoundRender(EntityRendererProvider.Context renderManager) {
        super(renderManager, new CoonhoundModel());
        this.addRenderLayer(new CoonhoundMarkingLayer(this));
        this.addRenderLayer(new CoonhoundCollarLayer(this));
        this.addRenderLayer(new CoonhoundDecorLayer(this));
    }

    @Override
    public void render(Coonhound entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
