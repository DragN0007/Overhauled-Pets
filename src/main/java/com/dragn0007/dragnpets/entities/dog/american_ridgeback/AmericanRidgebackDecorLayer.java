...
@OnlyIn(Dist.CLIENT)
public class AmericanRidgebackDecorLayer extends GeoRenderLayer<AmericanRidgeback> {
    public AmericanRidgebackDecorLayer(GeoRenderer<AmericanRidgeback> entityRendererIn) {
