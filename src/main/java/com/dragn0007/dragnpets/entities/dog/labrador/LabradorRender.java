...
import com.dragn0007.dragnpets.entities.dog.border_collie.*;
import com.mojang.blaze3d.vertex.PoseStack;
import net.minecraft.client.renderer.MultiBufferSource;
import net.minecraft.client.renderer.entity.EntityRendererProvider;
import software.bernie.geckolib.renderer.GeoEntityRenderer;

public class LabradorRender extends GeoEntityRenderer<Labrador> {

    public LabradorRender(EntityRendererProvider.Context renderManager) {
        super(renderManager, new LabradorModel());
        this.addRenderLayer(new LabradorMarkingLayer(this));
        this.addRenderLayer(new LabradorCollarLayer(this));
        this.addRenderLayer(new LabradorDecorLayer(this));
    }

    @Override
    public void render(Labrador entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
