...
@OnlyIn(Dist.CLIENT)
public class CoonhoundCollarLayer extends GeoRenderLayer<Coonhound> {

    public CoonhoundCollarLayer(GeoRenderer<Coonhound> entityRendererIn) {
        super(entityRendererIn);
    }

    @Override
    public void render(PoseStack poseStack, Coonhound animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
