...
@OnlyIn(Dist.CLIENT)
public class BeagleCollarLayer extends GeoRenderLayer<Beagle> {

    public BeagleCollarLayer(GeoRenderer<Beagle> entityRendererIn) {
        super(entityRendererIn);
    }

    @Override
    public void render(PoseStack poseStack, Beagle animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
