...
@OnlyIn(Dist.CLIENT)
public class CollieCollarLayer extends GeoRenderLayer<Collie> {
    ...
    public CollieCollarLayer(GeoRenderer<Collie> entityRendererIn) {
        super(entityRendererIn);
    }

    @Override
    public void render(PoseStack poseStack, Collie animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
