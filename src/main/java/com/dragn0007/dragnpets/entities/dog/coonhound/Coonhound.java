...
public class Coonhound extends ODog implements NeutralMob, GeoEntity {
   ...
   public Coonhound(EntityType<? extends Coonhound> entityType, Level level) {
   ...
   public static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(Coonhound.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> OVERLAY = SynchedEntityData.defineId(Coonhound.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Boolean> COLLARED = SynchedEntityData.defineId(Coonhound.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<Integer> CROPPED = SynchedEntityData.defineId(Coonhound.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> FLUFFY = SynchedEntityData.defineId(Coonhound.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> DATA_VEST_COLOR = SynchedEntityData.defineId(Coonhound.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Boolean> VEST = SynchedEntityData.defineId(Coonhound.class, EntityDataSerializers.BOOLEAN);
   ...
   public static final EntityDataAccessor<Integer> GENDER = SynchedEntityData.defineId(Coonhound.class, EntityDataSerializers.INT);
   ...
   public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
      ...
      Coonhound pup = null;
      Coonhound partner = (Coonhound) ageableMob;

      if (ageableMob instanceof Coonhound) {

         pup = POEntityTypes.COONHOUND_ENTITY.get().create(serverLevel);
   ...
   public boolean wantsToAttack(LivingEntity entity, LivingEntity p_30390_) {
      if (!(entity instanceof Creeper) && !(entity instanceof Ghast)) {
         if (entity instanceof Coonhound) {
            Coonhound wolf = (Coonhound)entity;
