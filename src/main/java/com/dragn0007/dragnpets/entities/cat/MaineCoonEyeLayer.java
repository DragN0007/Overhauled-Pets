...
public class MaineCoonEyeLayer extends GeoRenderLayer<MaineCoon> {
    ...
    public enum Eyes {
        BLUE(new ResourceLocation(PetsOverhaul.MODID, "textures/entity/cat/maine_coon/overlay/eyes_blue.png")),
        BROWN(new ResourceLocation(PetsOverhaul.MODID, "textures/entity/cat/maine_coon/overlay/eyes_brown.png")),
        GREEN(new ResourceLocation(PetsOverhaul.MODID, "textures/entity/cat/maine_coon/overlay/eyes_green.png")),
        ORANGE(new ResourceLocation(PetsOverhaul.MODID, "textures/entity/cat/maine_coon/overlay/eyes_orange.png")),
        YELLOW(new ResourceLocation(PetsOverhaul.MODID, "textures/entity/cat/maine_coon/overlay/eyes_yellow.png"));
