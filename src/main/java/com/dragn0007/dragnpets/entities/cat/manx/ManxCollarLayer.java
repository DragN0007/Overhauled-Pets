...
@OnlyIn(Dist.CLIENT)
public class ManxCollarLayer extends GeoRenderLayer<Manx> {


    public ManxCollarLayer(GeoRenderer<Manx> entityRendererIn) {
        super(entityRendererIn);
    }

    @Override
    public void render(PoseStack poseStack, Manx animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
