...
public class ParrotFollowOwnerGoal extends Goal {
   private final OParrot tamable;
   ...
   public ParrotFollowOwnerGoal(OParrot p_25294_, double v, float p_25296_, float p_25297_, boolean p_25298_) {
